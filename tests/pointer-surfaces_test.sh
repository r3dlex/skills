...
# ---------------------------------------------------------------------------
modules=(
  "03-configure-generate/ai-catapult-init/modules/validation.md"
  "03-configure-generate/ai-catapult-init/modules/workflow.md"
  "03-configure-generate/ai-catapult-init/modules/documentation-blueprint.md"
)
...
if grep -Fq 'generated `AGENTS.md` and `README.md` link to both workflow files.' 03-configure-generate/ai-catapult-init/modules/validation.md; then
...
if grep -Fq 'Generated `AGENTS.md` and `README.md` surfaces must link to both the workflow doc and the manifest' 03-configure-generate/ai-catapult-init/modules/workflow.md; then
...
if grep -Fq 'Generated `AGENTS.md` and `README.md` link to `.ai/workflows/repo-workflow.md`' 03-configure-generate/ai-catapult-init/modules/documentation-blueprint.md; then
...
if grep -Fq "GEMINI.md" 03-configure-generate/ai-catapult-init/modules/documentation-blueprint.md; then
