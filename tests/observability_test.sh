...
assert_file_contains "03-configure-generate/ai-catapult-init/modules/ci-policy.md" "token-cost" \
  "ci-policy.md carries the token-cost checklist keyword"
assert_file_contains "03-configure-generate/ai-catapult-init/modules/ci-policy.md" "trajectory-audit" \
  "ci-policy.md carries the trajectory-audit checklist keyword"
assert_file_contains "03-configure-generate/ai-catapult-init/modules/validation.md" "token-cost" \
  "validation.md carries the token-cost checklist keyword"
assert_file_contains "03-configure-generate/ai-catapult-init/modules/validation.md" "trajectory-audit" \
  "validation.md carries the trajectory-audit checklist keyword"
assert_file_contains "03-configure-generate/ai-catapult-init/modules/validation.md" ".ai/observability/" \
