...
assert_file_contains "03-configure-generate/ai-catapult-init/modules/documentation-blueprint.md" "ai-failure-modes.md" \
  "documentation-blueprint.md tree names the AI-failure-mode checklist"
assert_file_contains "03-configure-generate/ai-catapult-init/modules/documentation-blueprint.md" ".ai/reviews/" \
  "documentation-blueprint.md names the .ai/reviews/ surface"
assert_file_contains "03-configure-generate/ai-catapult-init/modules/validation.md" "ai-failure-modes.md" \
  "validation.md structural check names the AI-failure-mode checklist"
assert_file_contains "03-configure-generate/ai-catapult-init/modules/ci-policy.md" "ai-failure-modes.md" \
