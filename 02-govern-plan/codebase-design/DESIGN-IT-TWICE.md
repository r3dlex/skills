...
Run three or more passes. Each must produce a **radically different** interface for the deepened module.
...
Include both [SKILL.md](SKILL.md) vocabulary and the project's `CONTEXT.md` vocabulary in each brief, so every design names things consistently with the architecture language and the domain language.
