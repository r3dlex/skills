...
| [`grilling`](02-govern-plan/grilling/SKILL.md) | Interview relentlessly to stress-test a plan, decision, or idea. Use when thinking needs challenging before it hardens into work. | `stable` | `02-govern-plan` |
...
| [`implement`](03-configure-generate/implement/SKILL.md) | Implement a piece of work from a spec or set of tickets. Use when the decisions are already made and the work just needs building. | `stable` | `03-configure-generate` |
