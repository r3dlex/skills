...
|---|---|
| [`autobahn`](../04-validate-handoff/autobahn/SKILL.md) | 03-configure-generate, 04-validate-handoff |
| [`code-review`](../04-validate-handoff/code-review/SKILL.md) | 03-configure-generate, 04-validate-handoff |
| [`diagnose`](../04-validate-handoff/diagnose/SKILL.md) | 01-discover-decide, 03-configure-generate, 04-validate-handoff |
