...
Workflow fixture surfaces are generated under `.ai/workflows/`, `.ai/phases/`, and `.ai/handoff/`; generated `AGENTS.md`, `CLAUDE.md`, and `README.md` link to both workflow files.
